...
const textElement = document.getElementById('ellipsis-text-0');
const textElement2 = document.getElementById('ellipsis-text-1');
const textElement3 = document.getElementById('ellipsis-text-2');

const maxWords = 30; // Define the desired number of words to display

const truncateText = (element, numWords) => {
...
truncateText(textElement2, maxWords);
truncateText(textElement3, maxWords);
